...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.teImage_folder.setFocusPolicy(QtCore.Qt.NoFocus)
        ...
        self.checkBox.setGeometry(QtCore.QRect(970, 10, 70, 17))
    ...
    def retranslateUi(self, Form):
        ...
        self.checkBox.setText(_translate("Form", "Multi-Tag"))
